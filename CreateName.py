...
xing = [
    ...
    '熊', '纪', '舒', '屈', '项', '祝', '董', '梁','欧阳','令狐','司马','诸葛','西门']
...
ming = ['澄泓','存志','澹雅','得韬','德辉','方旭','飞轩','芳华','芳蕤','芳苓','彬蔚','彬彬','博裕','博闻','博文',
        '博艺','博雅','承德','朝宗','芳蔼','芳菲','管彤','和畅','涵畅','涵涵','浩初','浩丽','浩然','浩学'
]
...
def getName1():
    ...
    #UserName = x + m1 + m2
    UserName = x + m1
    Project.Variables.UserName = UserName  #设置姓名为全局变量
    #Log.Message("生成的用户姓名")
    Log.Message(Project.Variables.UserName)
    return UserName
...
def getName2():
    ...
    m2 = random.choice(ming)
    UserName = x + m1 + m2
    Project.Variables.PName = UserName  #设置姓名为全局变量
    Log.Message("生成的用户姓名")
    Log.Message(Project.Variables.PName)
    return UserName
